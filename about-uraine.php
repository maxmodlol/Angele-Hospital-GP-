                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped">
									...
									<?php
                                        ...
                                        $conn = new mysqli($servername, $username, $password, $dbname);
                                         $sql = "SELECT * FROM uraine_analysis WHERE id='$id'";
                                        ...
                                        <tr>
                                            <td><strong>Apperance</strong></td>
                                            <td>".$row['Apperance']."</td>
                                        </tr>
                                        <tr>
                                            <td><strong>leukonyce</strong></td>
                                            <td>".$row['leukonyce']."</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Protin </strong></td>
                                            <td>".$row['Protin']."</td>
                                        </tr>
                                        <tr>
								...
								const name =document.getElementById('id').value;
								        if(confirm("Are You Sure You want to delete this Report?")){
								            location.href='delete_uraine.php';
